    ...
    return (
        <div>
            <div className='articles'>
                <div className='text-center font-mono font-bold text-5xl mt-5 '><p>Read Our Latest Yoga Blogs</p></div>
                <div className='text-center text-xl mb-5 text-red-400'><p>Want to see more blogs?  </p></div>
                <div className='lg:grid grid-cols-3 ml-10 mb-5'>
                    <div className="card w-96 bg-base-100 shadow-xl mb-5" data-aos="zoom-in-up">
                    ...
                    <div className="card w-96 bg-base-100 shadow-xl mb-5" data-aos="zoom-in-down">
                    ...
                    <div className="card w-96 bg-base-100 shadow-xl mb-5" data-aos="zoom-in-left">
