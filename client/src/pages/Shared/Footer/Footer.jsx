...
const Footer = () => {
  return (
    <div>
      <footer className="footer p-2 bg-lime-400 text-base-content">
        <div>
          ...
          <img width="50" height="50" viewBox="0 0 24 24" src="/public/white-text-rectangle.png" alt="" />
          <p className='font-bold text-xl'>VumPros Industries Ltd.<br />Providing reliable tech since 1992</p>
        </div>
      ...
      <div className='text-center pb-2 text-xl bg-lime-400'>
